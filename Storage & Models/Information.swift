...
class Information: ObservableObject {
    ...
    @Published var info = [
        ...
        InfoCategory(
            id: 0,
            name: "Operations",
            desc: "These basic operations are the essential parts of a calculator. They make up the foundation of mathematics as a whole.",
            info: [
                ...
                InfoData(
                    ...
                    fullName: "Addition",
                    category: "Operations",
                    description: "Adds previous and next numbers together",
                    example1Q: ["2","+","3"],
                    example1A: ["5"],
                ...
                InfoData(
                    ...
                    category: "Operations",
                    description: "Subtracts next number from previous number",
                    example1Q: ["14","-","3"],
                    example1A: ["11"],
                ...
                InfoData(
                    ...
                    category: "Operations",
                    description: "Multiplies previous and next numbers together",
                    example1Q: ["4","×","-12"],
                    example1A: ["-48"],
                ...
                InfoData(
                    ...
                    fullName: "Division",
                    category: "Operations",
                    description: "Divides previous number by next number",
                    example1Q: ["364","÷","14"],
                    example1A: ["26"],
                ...
                InfoData(
                    ...
                    fullName: "Percent",
                    category: "Operations",
                    description: "Makes a quantity into a percent",
                    example1Q: ["24%"],
                    example1A: ["0.24"],
                    example2Q: ["37%","×","364"],
                    example2A: ["133.2"]
                ...
                InfoData(
                    ...
                    fullName: "Fraction",
                    category: "Operations",
                    description: "Makes a quantity into a fraction",
                    example1Q: ["“","4","/","7","‘"],
        ...
        InfoCategory(
            ...
            desc: "Exponents and roots can be used for a variety of reasons. They are used to find powers and roots of a number.",
            info: [
                ...
                InfoData(
                    ...
                    description: "Squares a number; raises a number to the 2nd power",
                    example1Q: ["17","^","2","v"],
                    example1A: ["289"],
                    example2Q: ["(","-4.78",")","^","2","v"],
                    example2A: ["22.8484"]
                ...
                InfoData(
                    ...
                    fullName: "Cube",
                    category: "Exponents & Roots",
                    description: "Cubes a number; raises a number to the 3rd power",
                    example1Q: ["6","^","3"],
                    example1A: ["216"],
                ...
                InfoData(
                    ...
                    category: "Exponents & Roots",
                    description: "Multiplies a number by 10 to the specified power",
                    example1Q: ["2.4","E","3"],
                    example1A: ["2400"],
                ...
                InfoData(
                    ...
                    fullName: "Inverse",
                    category: "Exponents & Roots",
                    description: "Raises a number to the -1; 1/number (inverse)",
                    example1Q: ["4","^","-1","v"],
                    example1A: ["0.25"],
                ...
                InfoData(
                    ...
                    fullName: "Cube Root",
                    category: "Exponents & Roots",
                    description: "Takes the cube root of a number",
                    example1Q: ["§","3","√","343","`"],
                    example1A: ["7"],
                ...
                InfoData(
                    ...
                    fullName: "xth Root",
                    category: "Exponents & Roots",
                    description: "Takes the specified root of a number",
                    example1Q: ["§","10","√","1024","`"],
                    example1A: ["2"],
        ...
        InfoCategory(
            ...
            info: [
                ...
                InfoData(
                    ...
                    category: "Logarithms",
                    description: "Finds the power of 10 equal to the specified number",
                ...
                InfoData(
                    ...
                    category: "Logarithms",
                    description: "Finds the power of e equal to the specified number",
                ...
                InfoData(
                    ...
                    category: "Logarithms",
                    description: "Finds the power of 2 equal to the specified number",
                ...
                InfoData(
                    id: 3,
                    name: "logₓ",
                    fullName: "Base x Logarithm",
                    category: "Logarithms",
                    description: "Finds the power of the specified base equal to the specified number",
                ...
                InfoData(
                    ...
                    category: "Logarithms",
                    description: "Finds 10 to the specified power",
                    example1Q: ["10","^","9","v"],
                ...
                InfoData(
                    ...
                    category: "Logarithms",
                    description: "Finds e to the specified power",
                    example1Q: ["e","^","2.54","v"],
                    example1A: ["12.679671"],
                    example2Q: ["e","^","-6.4","v"],
                ...
                InfoData(
                    ...
                    category: "Logarithms",
                    description: "Finds 2 to the specified power",
                    example1Q: ["2","^","13","v"],
                    example1A: ["8192"],
                    example2Q: ["2","^","§","#2","√","2","v"],
                    example2A: ["2.6651441"]
                ...
                InfoData(
                    id: 7,
                    name: "x^",
                    fullName: "Base x Power",
                    category: "Logarithms",
                    description: "Finds x to the specified power",
                    example1Q: ["4","^","19","v"],
        ...
        InfoCategory(
            ...
            info: [
                ...
                InfoData(
                    ...
                    fullName: "Cotangent",
                    category: "Trigonometry",
                    description: "The adjacent/opposite of an angle; x/y; 1/tan",
                    example1Q: ["cot","90","º"],
                    example1A: ["0"],
                    example2Q: ["cot","“","2π","/","3","‘"],
                ...
                InfoData(
                    ...
                    fullName: "Secant",
                    category: "Trigonometry",
                    description: "The hypotenuse/adjacent of an angle; r/x; 1/cos",
                    example1Q: ["sec","90","º"],
                    example1A: ["∞"],
                    example2Q: ["sec","“","2π","/","3","‘"],
                    example2A: ["-2"]
                ...
                InfoData(
                    ...
                    fullName: "Cosecant",
                    category: "Trigonometry",
                    description: "The hypotenuse/opposite of an angle; r/y; 1/sin",
                    example1Q: ["csc","90","º"],
                    example1A: ["1"],
                    example2Q: ["csc","“","2π","/","3","‘"],
                    example2A: ["1.1547005"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The angle whose sin is the specified value",
                    example1Q: ["sin⁻¹","(","0",")"],
                    example1A: ["0"],
                    example2Q: ["sin⁻¹","(","“","(","§","#2","√","3",")","`","/","2","‘",")"],
                    example2A: ["60"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The angle whose cos is the specified value",
                    example1Q: ["cos⁻¹","(","0",")"],
                    example1A: ["90"],
                    example2Q: ["cos⁻¹","(","“","(","§","#2","√","3",")","`","/","2","‘",")"],
                    example2A: ["30"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The angle whose tan is the specified value",
                    example1Q: ["tan⁻¹","(","0",")"],
                    example1A: ["0"],
                    example2Q: ["tan⁻¹","(","“","(","§","#2","√","3",")","`","/","2","‘",")"],
                    example2A: ["40.893395"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The angle whose cot is the specified value",
                    example1Q: ["cot⁻¹","(","0",")"],
                    example1A: ["90"],
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The angle whose sec is the specified value",
                    example1Q: ["sec⁻¹","(","0",")"],
                    example1A: ["Error"],
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The angle whose csc is the specified value",
                    example1Q: ["csc⁻¹","(","0",")"],
                    example1A: ["Error"],
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The hyperbolic angle whose sinh is the specified value",
                    example1Q: ["sinh⁻¹","(","0",")"],
                    example1A: ["0"],
                    example2Q: ["sinh⁻¹","(","20",")"],
                    example2A: ["211.393"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The hyperbolic angle whose cosh is the specified value",
                    example1Q: ["cosh⁻¹","(","0",")"],
                    example1A: ["Error"],
                    example2Q: ["cosh⁻¹","(","20",")"],
                    example2A: ["211.32138"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The hyperbolic angle whose tanh is the specified value",
                    example1Q: ["tanh⁻¹","(","0",")"],
                    example1A: ["0"],
                    example2Q: ["tanh⁻¹","(","20",")"],
                    example2A: ["Error"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The hyperbolic angle whose coth is the specified value",
                    example1Q: ["coth⁻¹","(","0",")"],
                    example1A: ["Error"],
                    example2Q: ["coth⁻¹","(","20",")"],
                    example2A: ["2.8671799"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The hyperbolic angle whose sech is the specified value",
                    example1Q: ["sech⁻¹","(","0",")"],
                    example1A: ["∞"],
                    example2Q: ["sech⁻¹","(","20",")"],
                    example2A: ["Error"]
                ...
                InfoData(
                    ...
                    category: "Trigonometry",
                    description: "The hyperbolic angle whose csch is the specified value",
                    example1Q: ["csch⁻¹","(","0",")"],
                    example1A: ["∞"],
                    example2Q: ["csch⁻¹","(","20",")"],
                    example2A: ["2.8635967"]
        ...
        InfoCategory(
            ...
            info: [
                ...
                InfoData(
                    ...
                    description: "The product of all integers from 1 to a number",
                    example1Q: ["4!"],
                    example1A: ["4","×","3","×","2","×","1"],
                    example2Q: ["4!"],
                    example2A: ["24"]
        ...
        InfoCategory(
            ...
            info: [
                ...
                InfoData(
                    ...
                    description: "Ratio of a circle's circumference:diameter (3.1415926…)",
                    example1Q: ["2","×","π"],
                    example1A: ["6.2831853"],
                    example2Q: ["8π","+","3π"],
                    example2A: ["34.557519"]
                ...
                InfoData(
                    ...
                    category: "Miscellaneous",
                    description: "Euler's Number, used for growth/decay + much more (2.7182818…)",
                    example1Q: ["4","×","e"],
                    example1A: ["10.873127"],
                    example2Q: ["e","^","4.5"],
                    example2A: ["90.017131"]
                ...
                InfoData(
                    ...
                    fullName: "Floor",
                    category: "Miscellaneous",
                    description: "Rounds a number down always",
                ...
                InfoData(
                    ...
                    fullName: "Ceiling",
                    category: "Miscellaneous",
                    description: "Rounds a number up always",
